...
class Runnable(Generic[Input, Output], ABC):
    ...
    * Async: Methods with "a" suffix are asynchronous. By default, they execute
    ...
    async def ainvoke(
        ...
        #     print(type(input))
        #     # Type is AddableDict
        #     input_holder: AddableDict = input
        #     try:
        #         question = input_holder['question']
        #         context = input_holder['context']
        #         file_embedding_keys = input_holder['file_embedding_keys']
        #         print(f"fuck you type: {type(context[1])}")
        #         print(f"runnable ainvoke question: {question}, context: , file_embedding_keys: {file_embedding_keys}: {traceback.print_stack()}")
        #     except Exception as e:
        #         print(f"Error parsing input: {e}")
        #         input_string = input_holder.__str__()
        #         # Check for 'state=' and slice the string before it.
        #         state_index = input_string.find("state=")
        #         if state_index != -1:
        #             modified_input = input[:state_index]
        #             print(f"runnable ainvoke {modified_input}: {traceback.print_stack()}")
        # else:
        #     print(f"runnable ainvoke input {input}: {traceback.print_stack()}")
    ...
    async def astream(
        ...
        **kwargs: Optional[Any],
        ...
        #     try:
        #         question = input_holder['question']
        #         context_processed = input_holder['context'][1].to_document().metadata
        #         file_embedding_keys = input_holder['file_embedding_keys']
        #         print(f"fuck you type: {type(context_processed)}")
        #         print(f"runnable ainvoke question: {question}, context: {context_processed}, file_embedding_keys: {file_embedding_keys}: {traceback.print_stack()}")
        #     except Exception as e:
        #         print(f"Error parsing input: {e}")
        #         input_string = input_holder.__str__()
        #         # Check for 'state=' and slice the string before it.
