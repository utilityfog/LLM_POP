...
class AsyncCompletions(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        print(f"openai resources chat completions chosen model: {model}")
        print(f"openai resources chat completions messages length: {len(str(messages))}")
        # trimmed_print("fucking messages: ", str(messages), max_length=100000)
