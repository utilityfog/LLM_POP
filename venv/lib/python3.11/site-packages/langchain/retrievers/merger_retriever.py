...
# from app.embeddings_manager import embeddings_storage, get_embedding
...
class MergerRetriever(BaseRetriever):
    ...
    async def amerge_documents(
        ...
        Returns:
            A list of merged documents.
        """
        # print(f"head: {final_documents[:20][:10]}")  # Prints the first 20 items
        # print(f"tail: {final_documents[-20:][:10]}")  # Prints the last 20 items
        ...
        # print(f"head: {merged_documents[:20][:10]}")  # Prints the first 20 items
        # print(f"tail: {merged_documents[-20:][:10]}")  # Prints the last 20 items
