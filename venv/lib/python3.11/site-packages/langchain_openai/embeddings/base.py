...
class OpenAIEmbeddings(BaseModel, Embeddings):
    ...
    def _get_len_safe_embeddings(
        ...
        print("langchain_openai safe embedding")
    ...
    async def _aget_len_safe_embeddings(
        ...
        print("langchain_openai embeddings aget_len_safe_embeddings")
        ...
        batched_embeddings: List[List[float]] = []
        _chunk_size = chunk_size or self.chunk_size
        async for i in tqdm(range(0, len(tokens), _chunk_size), desc="Generating Length-Safe Embeddings"):
    ...
    def embed_documents(
        ...
        print("langchain_openai embeddings embed_documents")
    ...
    async def aembed_documents(
        ...
        #       than the maximum context and use length-safe embedding function.
        engine = cast(str, self.deployment)
        return await self._aget_len_safe_embeddings(texts, engine=engine, chunk_size=chunk_size)
